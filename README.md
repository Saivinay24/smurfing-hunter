...
Below are actual outputs generated by `run_demo.py` from the provided `demo_results/`.
...
├── EVALUATION_DOSSIER.md    # Rubric-mapped project details for evaluators
└── demo_results/            # Example outputs (Graphs, Reports)
```
